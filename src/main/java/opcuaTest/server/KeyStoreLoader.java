...
class KeyStoreLoader {
    ...
    private static final String SERVER_ALIAS = "test-server";
    ...
    KeyStoreLoader load(File baseDir) throws Exception {
        ...
        File serverKeyStore = baseDir.toPath().resolve("test-server.pfx").toFile();
        ...
        if (!serverKeyStore.exists()) {
            ...
            String applicationUri = "urn:ca:uwo:test:server:" + UUID.randomUUID();

            SelfSignedCertificateBuilder builder = new SelfSignedCertificateBuilder(keyPair)
                .setCommonName("Test Server")
                .setOrganization("uwo.ca")
                .setOrganizationalUnit("edu")
                .setLocalityName("London")
                .setStateName("ON")
                .setCountryCode("CA")
